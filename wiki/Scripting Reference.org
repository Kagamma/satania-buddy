...
- The data retrieve from flag is not mutable.
- You can you this function, combined with set(), to exchange data between multiple scripts.
...
- You can you this function, combined with get(), to exchange data between multiple scripts.
