...
begin
  ...
  Script.RegisterFunc('buffer_u8_get', @SEBufferGetU8, 2);
  Script.RegisterFunc('buffer_u16_get', @SEBufferGetU16, 2);
  Script.RegisterFunc('buffer_u32_get', @SEBufferGetU32, 2);
  Script.RegisterFunc('buffer_u64_get', @SEBufferGetU64, 2);
  Script.RegisterFunc('buffer_i8_get', @SEBufferGetI8, 2);
  Script.RegisterFunc('buffer_i16_get', @SEBufferGetI16, 2);
  Script.RegisterFunc('buffer_i32_get', @SEBufferGetI32, 2);
  Script.RegisterFunc('buffer_i64_get', @SEBufferGetI64, 2);
  Script.RegisterFunc('buffer_f64_get', @SEBufferGetF64, 2);
