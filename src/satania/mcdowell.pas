...
begin
  ...
  Script.RegisterFunc('buffer_create', @SEBufferCreate, 1);
  Script.RegisterFunc('buffer_length', @SEBufferLength, 1);
  Script.RegisterFunc('buffer_u8_get', @SEBufferGetU8, 1);
  Script.RegisterFunc('buffer_u16_get', @SEBufferGetU16, 1);
  Script.RegisterFunc('buffer_u32_get', @SEBufferGetU32, 1);
  Script.RegisterFunc('buffer_u64_get', @SEBufferGetU64, 1);
  Script.RegisterFunc('buffer_i8_get', @SEBufferGetI8, 1);
  Script.RegisterFunc('buffer_i16_get', @SEBufferGetI16, 1);
  Script.RegisterFunc('buffer_i32_get', @SEBufferGetI32, 1);
  Script.RegisterFunc('buffer_i64_get', @SEBufferGetI64, 1);
  Script.RegisterFunc('buffer_f64_get', @SEBufferGetF64, 1);
  Script.RegisterFunc('buffer_u8_set', @SEBufferSetU8, 2);
  Script.RegisterFunc('buffer_u16_set', @SEBufferSetU16, 2);
  Script.RegisterFunc('buffer_u32_set', @SEBufferSetU32, 2);
  Script.RegisterFunc('buffer_u64_set', @SEBufferSetU64, 2);
  Script.RegisterFunc('buffer_i8_set', @SEBufferSetI8, 2);
  Script.RegisterFunc('buffer_i16_set', @SEBufferSetI16, 2);
  ...
  Script.RegisterFunc('string_to_buffer', @SEStringToBuffer, 1);
  Script.RegisterFunc('buffer_to_string', @SEBufferToString, 1);       
  Script.RegisterFunc('wbuffer_to_string', @SEWBufferToString, 1);
