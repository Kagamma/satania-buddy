...
begin
  ...
  Script.RegisterFunc('buffer_get_u8', @SEBufferGetU8, 2);
  Script.RegisterFunc('buffer_get_u16', @SEBufferGetU16, 2);
  Script.RegisterFunc('buffer_get_u32', @SEBufferGetU32, 2);
  Script.RegisterFunc('buffer_get_u64', @SEBufferGetU64, 2); 
  Script.RegisterFunc('buffer_get_i8', @SEBufferGetI8, 2);
  Script.RegisterFunc('buffer_get_i16', @SEBufferGetI16, 2);
  Script.RegisterFunc('buffer_get_i32', @SEBufferGetI32, 2);
  Script.RegisterFunc('buffer_get_i64', @SEBufferGetI64, 2);
  Script.RegisterFunc('buffer_get_f64', @SEBufferGetF64, 2);    
